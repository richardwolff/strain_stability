...
core_genes_directory = ("%score_genes/" % data_directory)
external_core_genes_directory = ("%score_genes/external/" % data_directory)
...
if __name__=='__main__':
    ...
    for species_name in pangenome_species:
        ...
        gene_samples, gene_names, gene_presence_matrix, gene_depth_matrix, marker_coverages, gene_reads_matrix = parse_midas_data.parse_pangenome_data(species_name=species_name)
        sys.stderr.write("Done!\n")  
