import sample_utils, config, parse_midas_data, sfs_utils, diversity_utils, gene_diversity_utils, core_gene_utils, snps_utils
...
for species_name in good_species_list:
		...
		same_subject_idxs = sample_utils.calculate_ordered_same_subject_pairs(sample_order_map, snp_samples, 'nonconsecutive')
		
		if len(same_subject_idxs[0]) < 0:
