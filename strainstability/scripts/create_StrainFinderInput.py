...
while final_line_number >= 0:
    ...
    snp_samples, allele_counts_map, passed_sites_map, final_line_number = parse_midas_data.parse_snps(species_name,debug=debug, allowed_variant_types=set(['1D','2D','3D','4D']),chunk_size=chunk_size, initial_line_number=final_line_number, allowed_genes=[],allowed_samples=host_samples)
