...
#
def calculate_snp_differences_between(i,j,allele_counts_map, passed_sites_map, avg_depth_i, avg_depth_j, allowed_variant_types=set([]), allowed_genes=set([]), lower_threshold=config.temporal_lower_threshold, 
